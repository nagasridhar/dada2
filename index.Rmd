&nbsp;
<center>
![The DADA2 R package](images/DADA2_Logo_Text_1_36_640.png)
</center>
...
####**<span style="color:red">Version 1.36 of the dada2 R package has been released. See the [release notes.](ReleaseNotes_1_36.html)</span>**

&nbsp;

## Installation

Binaries for the current release version of DADA2 (1.36.0) are available from Bioconductor. Note that you must have R 4.5 or newer, and [Bioconductor version 3.21](https://www.bioconductor.org/install/), to install the current release from Bioconductor.
